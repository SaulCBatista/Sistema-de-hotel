...
public class RegistroReservas extends JFrame{
	...
	public RegistroReservas() {
		...
		txtValor.setBounds(135, 332, 60, 25);
		txtValor.setForeground(SystemColor.textHighlight);
		txtValor.setFont(new Font("Roboto", Font.BOLD, 17));
		...
		txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(dataE != null & dataS != null) {
					try {
						valor = new ReservasController().calcularValor(dataE, dataS).toString();
		...
		btnProximo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (RegistroReservas.txtDataE.getDate() != null && RegistroReservas.txtDataS.getDate() != null) {
					Integer idDaReserva = new ReservasController().registrar(txtDataE.getDate(), txtDataS.getDate(), txtFormaPagamento.getSelectedItem().toString());
					RegistroHospede registro = new RegistroHospede(idDaReserva);
